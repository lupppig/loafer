...
- Reworked the project README into a concise overview of Loafer's purpose, current boundaries,
  execution model, architectural decisions, repository layout, and development path.
