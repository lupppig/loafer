    ...
    <>
      ...
      >
        <div className="w-full max-w-7xl px-6 flex items-center justify-between">
          <Link 
            href="/"
            className="font-sans font-semibold text-base text-text-primary flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-signal rounded-sm transition-opacity hover:opacity-80"
          >
            <LoaferMark size={19} />
            loafer
          </Link>
