    ...
    <footer className="bg-bg-surface border-t border-border-subtle py-12">
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          <Link href="/" className="font-sans font-semibold text-base text-text-primary outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-sm transition-opacity hover:opacity-80">
            loafer
          </Link>
          <div className="flex items-center gap-6 text-[13px] text-text-secondary">
            <Link href="/docs" className="hover:text-text-primary hover:underline underline-offset-4 decoration-border-strong outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-sm transition-colors">Docs</Link>
            ...
            <Link href="/changelog" className="hover:text-text-primary hover:underline underline-offset-4 decoration-border-strong outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-sm transition-colors">Changelog</Link>
